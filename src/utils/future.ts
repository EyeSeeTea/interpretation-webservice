...
export class Future<E, D> {
    ...
    static build<E, D>(value: D | undefined, err: E): Future<E, D> {
        return value === undefined ? Future.error(err) : Future.success(value);
    }
...
export function wait<E>(seconds: number): Future<E, void> {
